...
\begin{figure}
    \begin{center}
       \scalebox{0.6} {\input{figures/forme_onda.pgf}}
    \end{center}
...
\begin{figure}
    \begin{center}
       \scalebox{0.6} {\input{figures/misure_ampiezza.pgf}}
    \end{center}
...
\begin{figure}
    \begin{center}
       \scalebox{0.6} {\input{figures/ampiezza_istantanea.pgf}}
    \end{center}
...
\begin{figure}
    \begin{center}
       \scalebox{0.6} {\input{figures/ampiezza_picco.pgf}}
    \end{center}
...
\begin{figure}
    \begin{center}
       \scalebox{0.6} {\input{figures/ampiezza_picco_picco.pgf}}
    \end{center}
...
\begin{figure}
    \begin{center}
       \scalebox{0.6} {\input{figures/log.pgf}}
    \end{center}
